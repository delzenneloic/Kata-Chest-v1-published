...
public class Position {
	int rank; // Represent a line.
	int file; // represent a column
	...
	public boolean is_inside_board() {
		return 0<=this.rank && this.rank< Board.SIZE && 0<=this.file && this.file< Board.SIZE; 
	}
